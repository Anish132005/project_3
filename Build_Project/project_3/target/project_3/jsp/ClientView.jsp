				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								<span class="pl-sm-5"><b>position</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="position" class="form-control"
											...
											value="<%=DataUtility.getStringData(dto.getPosition())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("position", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="salary" class="form-control"
											...
											value="<%=DataUtility.getStringData(dto.getSalary())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("salary", request)%></font></br>



								<span class="pl-sm-5"><b>birthDate</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
								...
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("birthDate", request)%></font></br>
							</div>
							</br>
							<%
								if (id > 0) {
