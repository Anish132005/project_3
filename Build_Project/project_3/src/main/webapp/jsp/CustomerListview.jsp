		...
		<form class="pb-5" action="<%=ORSView.CUSTOMER_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<font color="red" id="locationError"></font>
				</div>

				<div class="col-sm-2">
					<input type="text" name="contactNumber"
						placeholder="Enter contactNumber" class="form-control"
						oninput="validateMobileNo(event)"
		...
		<table class="table table-bordered table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="20%" class="text">Location</th>
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=CustomerListCtl.OP_BACK%>">
		</div>
