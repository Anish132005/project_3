<%@page import="in.co.rays.project_3.controller.FavoriteListListCtl"%>
<%@page import="in.co.rays.project_3.dto.FavoriteListDto"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.FAVORITELIST_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto"
			...
			<%
				...
				Iterator<FavoriteListDto> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">

					<u>favoriteList List</u>
				</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="customerUserName"
						...
						value="<%=ServletUtility.getParameter("customerUserName", request)%>">
				...
				<div class="row">
					<div class="col-sm-1"></div>
					<div class="col-sm-2">
						<input type="text" name="notesOrComments"
							placeholder="Enter notesOrComments" class="form-control"
							oninput="handleLetterInput(this, 'nameError', 30)"
							onblur="validateLetterInput(this, 'nameError', 30)"
							value="<%=ServletUtility.getParameter("notesOrComments", request)%>">
 ...
 --%>
					...
					<center>
						<div class="col-sm-2">
							<input type="submit" class="btn btn-primary btn-md"
								...
								value="<%=FavoriteListListCtl.OP_SEARCH%>"> &emsp; <input
								type="submit" class="btn btn-dark btn-md"
								style="font-size: 15px" name="operation"
								value="<%=FavoriteListListCtl.OP_RESET%>">
						</div>
					</center>
					...
					<table class="table table-bordered table-dark table-hover">
						<thead>
							<tr style="background-color: purple;">
								...
								<th width="20%" class="text">addedDate</th>
						...
						<tbody>
							<tr>
								...
								<td class="text"><%=DataUtility.getDateString(dto.getAddedDate())%></td>
								<td class="text"><%=dto.getCustomerUserName()%></td>
								<td class="text"><%=dto.getNotesOrComments()%></td>


								<td class="text"><a
									href="FavoriteListCtl?id=<%=dto.getId()%>">Edit</a></td>
							</tr>
						</tbody>
						<%
							}
				...
				<table width="100%">
					<tr>
						<td><input type="submit" name="operation"
							...
							value="<%=FavoriteListListCtl.OP_PREVIOUS%>"
							<%=pageNo > 1 ? "" : "disabled"%>></td>

						<td><input type="submit" name="operation"
							class="btn btn-primary btn-md" style="font-size: 17px"
							value="<%=FavoriteListListCtl.OP_NEW%>"></td>

						<td><input type="submit" name="operation"
							class="btn btn-danger btn-md" style="font-size: 17px"
							value="<%=FavoriteListListCtl.OP_DELETE%>"></td>

						<td align="right"><input type="submit" name="operation"
							class="btn btn-warning btn-md" style="font-size: 17px"
							style="padding: 5px;" value="<%=FavoriteListListCtl.OP_NEXT%>"
				...
				%>
				<center>
					<h1 style="font-size: 40px; color: #162390;">FavoriteList List</h1>
				</center>
				</br>
				<div class="row">
					<div class="col-md-4"></div>
					...
					<div style="padding-left: 48%;">
						<input type="submit" name="operation"
							class="btn btn-primary btn-md" style="font-size: 17px"
							value="<%=FavoriteListListCtl.OP_BACK%>">
					</div>
