<%@page import="in.co.rays.project_3.dto.ItemInformationDto"%>
<%@page import="in.co.rays.project_3.controller.ItemInformationListCtl"%>
...
<title>ItemInformation List</title>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.ITEMINFORMTION_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto"
			...
			<%
				...
				Iterator<ItemInformationDto> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">

					<u>ItemInformation List</u>
				</h1>
			</center>
 ...
 --%>
					...
					<center>
						<div class="col-sm-2">
							<input type="submit" class="btn btn-primary btn-md"
								...
								value="<%=ItemInformationListCtl.OP_SEARCH%>"> &emsp; <input
								type="submit" class="btn btn-dark btn-md"
								style="font-size: 15px" name="operation"
								value="<%=ItemInformationListCtl.OP_RESET%>">
						</div>
					</center>
					...
					<table class="table table-bordered table-dark table-hover">
						<thead>
							<tr style="background-color: purple;">
								...
								<th width="20%" class="text">overView</th>
						...
						<tbody>
							<tr>
								...
								<td class="text"><a
									href="ItemInformationCtl?id=<%=dto.getId()%>">Edit</a></td>
							</tr>
						</tbody>
						<%
							}
				...
				<table width="100%">
					<tr>
						...
						<td align="right"><input type="submit" name="operation"
							class="btn btn-warning btn-md" style="font-size: 17px"
							style="padding: 5px;" value="<%=ItemInformationListCtl.OP_NEXT%>"
				...
				%>
				<center>
					<h1 style="font-size: 40px; color: #162390;">ItemInformation
						List</h1>
				</center>
				</br>
				<div class="row">
					...
					<div style="padding-left: 48%;">
						<input type="submit" name="operation"
							class="btn btn-primary btn-md" style="font-size: 17px"
							value="<%=ItemInformationListCtl.OP_BACK%>">
					</div>
