					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="clientName"
											placeholder="Enter clientName" class="form-control"
								...
								<font color="red" class="pl-sm-5" id="nameError"> <%=ServletUtility.getErrorMessage("clientName", request)%></font></br>
								...
								<font color="red" class="pl-sm-5" id="nameError"> <%=ServletUtility.getErrorMessage("Location", request)%></font></br>
								...
								<font color="red" class="pl-sm-5" id="nameError"> <%=ServletUtility.getErrorMessage("contactNumber", request)%></font></br>
