o<%@page import="in.co.rays.project_3.controller.LoginCtl"%>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Client
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.CLIENT_CTL%>"><i
							class="fa fa-file"></i>Add client</a> <a class="dropdown-item"
							href="<%=ORSView.CLIENT_LIST_CTL%>"><i class="fa fa-paste"></i>client
							List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">ProductDetails</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">purchaseOrder</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PURCHASEORDER_CTL%>"><i
							class="fa fa-calculator"></i>Add purchaseOrder</a> <a
							class="dropdown-item" href="<%=ORSView.PURCHASEORDER_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i>purchaseOrder List
						</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">CarDetails</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.CAR_CTL%>"><i
							class="fa fa-calculator"></i>Add CAR</a> <a class="dropdown-item"
							href="<%=ORSView.CAR_LIST_CTL%>"> <i
							class="fa fa-sort-amount-down"></i>Car List
						</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">CartOverView
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.CARTOVERVIEW_CTL%>"><i
							class="fa fa-file"></i>Add CartOverView</a> <a class="dropdown-item"
							href="<%=ORSView.CARTOVERVIEW_LIST_CTL%>"><i
							class="fa fa-paste"></i>CartOverView List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">ItemInFormation
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.ITEMINFORMATION_CTL%>"><i
							class="fa fa-file"></i>Add ItemInFormation</a> <a
							class="dropdown-item" href="<%=ORSView.ITEMINFORMTION_LIST_CTL%>"><i
							class="fa fa-paste"></i>ItemInFormation List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">FavoriteList
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.FAVORITELIST_CTL%>"><i
							class="fa fa-file"></i>Add FavoriteList</a> <a class="dropdown-item"
							href="<%=ORSView.FAVORITELIST_LIST_CTL%>"><i
							class="fa fa-paste"></i>FavoriteList List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Customer
					</font></a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.CUSTOMER_CTL%>"><i
							class="fa fa-file"></i>Add Customer</a> <a
							class="dropdown-item" href="<%=ORSView.CUSTOMER_LIST_CTL%>"><i
							class="fa fa-paste"></i>Customer List</a>
					</div></li>
