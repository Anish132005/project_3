			...
			<div class="row pt-3">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								...
								<%
									Map map = (Map) request.getAttribute("pr");
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5" id="nameError"> <%=ServletUtility.getErrorMessage("product", request)%></font></br>
					...
					: DataUtility.getStringData(dto.getTotalquantity())%>">
								...
								<font color="red" class="pl-sm-5" id="priceError"> <%=ServletUtility.getErrorMessage("totalquantity", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="totalCost"
											...
											oninput="handleIntegerInput(this, 'priceError', 7)"
											onblur="validateIntegerInput(this, 'priceError', 7)"
											value="<%=DataUtility.getStringData(dto.getTotalCost()).equals("0.0") ? ""
					: DataUtility.getStringData(dto.getTotalCost())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5" id="priceError"> <%=ServletUtility.getErrorMessage("totalCost", request)%></font></br>
