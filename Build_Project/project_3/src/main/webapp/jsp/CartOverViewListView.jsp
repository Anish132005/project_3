...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.CARTOVERVIEW_LIST_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.CartOverviewDto"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" id="datepicker" name="TransationDate"
						...
						readonly="readonly"
						value="<%=ServletUtility.getParameter("TransationDate", request)%>">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">TransationDate</th>
							<th width="15%" class="text">QuantityOrdered</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getTransationDate())%></td>
							<td class="text"><%=dto.getQuantityOrdered()%></td>

							<td class="text"><a href="CartOverViewCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=CartOverViewListCtl.OP_BACK%>">
				</div>
