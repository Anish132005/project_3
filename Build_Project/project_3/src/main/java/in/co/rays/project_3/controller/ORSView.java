...
public interface ORSView {
	...
	public String FAVORITELIST_VIEW = PAGE_FOLDER + "/FavoriteListView.jsp";
	public String FAVORITELIST_LIST_VIEW = PAGE_FOLDER + "/FavoriteListListView.jsp";
	...
	public String CLIENT_LIST_VIEW = PAGE_FOLDER + "/ClienttListView.jsp";
	...
	public String ITEMINFORMTION_LIST_CTL = APP_CONTEXT + "/ctl/ItemInformationListCtl";

	public String FAVORITELIST_CTL = APP_CONTEXT + "/ctl/FavoriteListCtl";
	public String FAVORITELIST_LIST_CTL = APP_CONTEXT + "/ctl/FavoriteListListCtl";
